package ru.strict.controltime.view.settings.main.component;
...
import ru.strict.controltime.view.settings.main.event.SettingsTopic;
import ru.strict.controltime.view.settings.main.event.ShowCreateTaskEvent;
...
public class TasksSettingsWindow extends BaseWindow {
    ...
    public TasksSettingsWindow(
        ...
        CommonValidator.throwIfNull(actualTasks, "actualTasks");
        CommonValidator.throwIfNull(viewEventBroker, "viewEventBroker");
    ...
    protected void initComponents() {
        ...
        addTaskButton.addActionListener(this::showCreateTaskWindow);
    ...
    private void showCreateTaskWindow(ActionEvent event) {
        ...
        var showCreateTaskEvent = ShowCreateTaskEvent.builder().
                windowLocationX((int)sourceLocation.getX() - (windowWidth / 2)).
                windowLocationY((int)sourceLocation.getY() - 50).
                build();

        viewEventBroker.sendEvent(SettingsTopic.showCreateTask, showCreateTaskEvent);
    }
